...
public class PicsimLab implements Subject, Party, MDBDebugTool {
    ...
    private static final boolean DEBUG = false; //FIXME 
    ...
    private static final byte GETNAM = 0x36;
...
// Writes provided 4-byte integer to a 4 element byte array in Little-Endian order.
    ...
    public boolean sendcmd(byte cmd, int si, byte[] data_in, int so, byte[] data_out) {
        ...
        if (DEBUG) {
            System.out.println(" sendcmd(" + cmd + "," + si + ",data_in," + so + ",data_out)\n");
        }
        ...
        try {
            ...
            if (DEBUG) {
                System.out.println("write cmd Ok\n");
            }
        } catch (IOException e1) {
            e1.printStackTrace();
            if (DEBUG) {
                System.out.println("write cmd Error\n");
            }
            return false;
        }
        ...
        if (si >= 1) {
            try {
                ...
                mBufferedOutputStream.flush();
                if (DEBUG) {
                    System.out.println("write data cmd Ok\n");
                }
            } catch (IOException e1) {
                e1.printStackTrace();
                if (DEBUG) {
                    System.out.println("write cmd data error\n");
                }
                return false;
            }
        }
        ...
        if (so >= 1) {
            try {
                ...
                if (bytesRead != so) {
                    if (DEBUG) {
                        System.out.println("Write cmd read Error\n");
                    }
                    return false;
                } else {
                    if (DEBUG) {
                        System.out.println("Write cmd read Ok\n");
                    }
                }
        ...
        try {
            ...
            if (DEBUG) {
                System.out.println("Write cmd response Ok\n");
            }
        } catch (IOException e1) {
            e1.printStackTrace();
            if (DEBUG) {
                System.out.println("Write cmd response Error\n");
            }
            return false;
        }
        ...
        if (bytesRead != 1) {
            ...
            if (DEBUG) {
                System.out.println("Write cmd comm Error\n");
            }
            return false;
        }
        ...
        if (responseBytes[0] != 0x00) {
            if (DEBUG) {
                System.out.println("Write cmd response rec not Ok\n");
            }
            return false;
        }

        if (DEBUG) {
            System.out.println("Write cmd response rec Ok\n");
        }
        return true;
    }
    ...
    public boolean Attach(Observer observer, Object obj) {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Attach() was called");
        }
    ...
    public boolean Detach(Observer observer, Object obj) {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Detach() was called");
        }
        return true;
    }
    ...
    public void Notify(Object obj) {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Notify() was called");
        }
    }
    ...
    public void Engage(Assembly assembly) throws PartyException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Engage() was called");
        }
    ...
    public void Dismiss() {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Dismiss() was called");
        }
        this.assembly = null;
    }
    ...
    public void SetHWTool(MPLABCommTool Tool) {
        ...
        // called.
        if (DEBUG) {
            System.out.println("PicsimLab.SetHWTool() was called");
        }
        this.tool = Tool;
    ...
    public boolean ConnectToTool(CONNECTION_TYPE type) throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ConntectToTool() was called");
        }
    ...
    public boolean ProgramTarget(PROGRAM_OPERATION op) throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ProgramTarget() was called");
        }
        ...
        PNAME = assembly.GetDeviceName();
        if (DEBUG) {
            System.out.println("MCU Name=" + PNAME + "\n");
        }

        byte pname[] = new byte[20];
        if (!sendcmd(GETNAM, 0, null, 20, pname)) {
        ...
        String spname = new String(pname, 1, pname[0]);
        if (!PNAME.equalsIgnoreCase(spname)) {
            mm.handleMessage(new Message("MCU Name don't match!!!!!!:[" + PNAME + "]!=[" + spname + "]\n", "picsim", Color.red, true, true, true), ActionList.OutputWindowOnlyDisplayColor);
            return false;
        }
        ...
        if (DEBUG) {
            System.out.println("mem start=" + datai + "\n stop=" + dataf + "\n");
        }
        ...
        if (DEBUG) {
            System.out.println("code start=" + codei + "\n stop=" + codef + "\n");
        }
        ...
        if (DEBUG) {
            System.out.println("conf start=" + confi + "\n stop=" + conff + "\n");
        }
        ...
        ids = (int) (idf - idi);
        if (DEBUG) {
            System.out.println("ID start=" + idi + "\n stop=" + idf + "\n");
        }
        ...
        ees = (int) (eef - eei);
        if (DEBUG) {
            System.out.println("eeprom start=" + eei + "\n stop=" + eef + "\n");
        }
...
//  TODO user ID
    ...
    public void HoldTargetInReset() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.HoldTargetInReset() was called");
        }
    }
    ...
    public void ReleaseTargetFromReset() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ReleaseTargetFromReset() was called");
        }
    }
    ...
    public boolean ReadTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ReadTarget() was called");
        }
    ...
    public boolean RunTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.RunTarget() was called");
        }
    ...
    public boolean SingleStepTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.SingleStepTarget() was called");
        }
        return true;
    }
    ...
    public boolean BeginFastOp() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.BeginFastOp() was called");
        }
        return true;
    }
    ...
    public boolean FastStep() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.FastStep() was called");
        }
        SingleStepTarget();
        return true;
    }
    ...
    public boolean EndFastOp() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.EndFastOp() was called");
        }
        return true;
    }
    ...
    public boolean VerifyTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.VerifyTarget() was called");
        }
        return true;
    }
    ...
    public boolean EraseTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.EraseTarget() was called");
        }
        return true;
    }
    ...
    public boolean BlankCheckTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.BlankCheckTarget() was called");
        }
        return true;
    }
    ...
    public boolean HaltTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.HaltTarget() was called");
        }
    ...
    public boolean ResetTarget() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ResetTarget() was called");
        }
    ...
    public void SetPC(long address) throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.SetPC() was called");
        }
    }
    ...
    public long ReadTargetMemory(MEMTYPE memtype, long address, long size, byte[] data) throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.ReadTargetMemory() was called");
        }
        return 0L;
    }
    ...
    public long WriteTargetMemory(MEMTYPE memtype, long address, long size, byte[] data) throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.WriteTargetMemory() was called");
        }
        return 0L;
    }
    ...
    public void Abort() throws MDBCommonToolException {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.Abort() was called");
        }
    }
    ...
    public Long GetStopwatchValue() {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.GetStopwatchValue() was called");
        }
        return null;
    }
    ...
    public boolean SupportsDebugModeRead() {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.SupportsDebugModeRead() was called");
        }
        return true;
    }
    ...
    public Collection<ProjectStatusInfo> GetProjectStatusInfo() {
        ...
        if (DEBUG) {
            System.out.println("PicsimLab.GetProjectStatusInfo() was called");
        }
        return null;
    }
    ...
    public void TestTool() {
        if (DEBUG) {
            System.out.println("PicsimLab.TestTool() was called");
        }
